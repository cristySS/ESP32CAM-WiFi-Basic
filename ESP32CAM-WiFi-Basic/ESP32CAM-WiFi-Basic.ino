...
// Datos de Red
const char* ssid = "Totalplay-DFA0";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "DFA051FD9NC6vk6n";  // Escribe la contraseña de dicha red
